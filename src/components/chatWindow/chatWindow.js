...
export default class ChatWindow extends Component {
  constructor(props) {
    ...
    this.state = {
      users: [],
      messageToUser: { _id: "609130ef62cc32439058e53b" },
      ws: null,
      chats: {},
  ...
  async componentDidMount() {
    ...
    try {
      ...
      const defaultUserContacts = [
        { name: "mahdi", _id: "609130ef62cc32439058e53b", img: "https://mpng.subpng.com/20180523/tha/kisspng-businessperson-computer-icons-avatar-clip-art-lattice-5b0508dc6a3a10.0013931115270566044351.jpg", },
        { name: "ahmed", _id: "6091316762cc32439058e53c", img: "https://www.bradfieldconsulting.net/wp-content/uploads/2019/08/avatar-man.png", },
        { name: "mohammed", _id: "609131cb62cc32439058e53d", img: "https://www.pavilionweb.com/wp-content/uploads/2017/03/man-300x300.png", }
      ].filter(user => user._id !== this.props.loggedInUserObj._id );
      console.log(defaultUserContacts);
      this.setState({ users: defaultUserContacts });
    } catch (error) {
